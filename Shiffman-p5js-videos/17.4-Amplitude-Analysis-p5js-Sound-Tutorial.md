...
In Part 4 of the Sound with p5.js series, I show how to analyze the amplitude (i.e. volume) of a song (any sound input) to control elements of a p5.js sketch.

-   🔗  17.4: Amplitude Analysis - p5.js Sound Tutorial: https://youtu.be/NCCHQwNAN6Y 
-   🎥  Next video: https://youtu.be/40Me1-yAtTc  
