 ...
 In this "p5.js Sound Tutorial", I use the getLevel() function from the p5.js Sound Library to graph the amplitude (volume) over time. 

-   🔗  17.9: Sound Visualization: Graphing Amplitude - p5.js Sound Tutorial: https://youtu.be/jEwAMgcCgOA 
-   🎥  Next video: https://youtu.be/h_aTgOl9J5I  
...
-   🔗  p5.getLevel function reference: https://p5js.org/reference/#/p5.Amplitude/getLevel
