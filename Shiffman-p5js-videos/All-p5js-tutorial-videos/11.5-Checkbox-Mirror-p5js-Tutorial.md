...
This video looks at how to read the pixels from a live video and alter DOM elements (checkboxes) to create an abstract mirror.

-   🔗  11.5: Checkbox Mirror - p5.js Tutorial: https://youtu.be/m1G6WBvrOBE 
-   🎥  Next video: https://youtu.be/0V3uYA1hafk
