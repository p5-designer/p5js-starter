 ...
 This video looks at how to to use the Giphy API with p5 createImg() function to display GIFs from giphy on a web page.  Rainbows and Ryan Gosling are discussed.

-   🔗  10.10: The Giphy API and JavaScript - p5.js Tutorial: https://youtu.be/mj8_w11MvH8
-   🎥  Next video: https://youtu.be/ZiYdOwOrGyc 
