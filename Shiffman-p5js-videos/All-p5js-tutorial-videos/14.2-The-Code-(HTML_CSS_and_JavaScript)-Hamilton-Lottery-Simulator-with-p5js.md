 # 14.2: The Code (HTML, CSS, and JavaScript) - Hamilton Lottery Simulator with p5.js

 In this video, I cover the basics of simulating a lottery in JavaScript.  How do you pick a random number to determine if you have won or not?  How do you keep track of how many times you have played the lottery?  How do you display the results on a webp

-   🔗  14.2: The Code (HTML, CSS, and JavaScript) - Hamilton Lottery Simulator with p5.js: https://youtu.be/ZyiYux7Zqzc  
-   🎥  Next video: https://youtu.be/LoSJN9QYpz0  
